// Daily scraper using direct TikTok API with pagination to fetch 100 products
...
async function fetchAllProducts() {
  ...
  console.log('📡 Fetching 100 products with pagination from TikTok API...');
...
async function main() {
  try {
    console.log('🚀 Starting Daily Trending Products Scraper (100 Products) - Direct API...');
