// Vercel serverless function for daily TikTok trending products scraper
...
async function main() {
  try {
    console.log('🚀 Starting Daily Trending Products Scraper - Vercel Cron...');
    ...
    return {
      ...
      totalGMV: totalGMV,
      message: `Successfully scraped ${products.length} products with £${totalGMV.toLocaleString()} total GMV`
    };
...
export default async function handler(req, res) {
  ...
  try {
    console.log('🕘 Vercel Cron Job Triggered - Daily TikTok Scraper');
