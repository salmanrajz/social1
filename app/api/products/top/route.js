...
export async function GET(request) {
  try {
    ...
    return NextResponse.json({ error: "Failed to fetch top products", details: error.message }, { status: 500 });
  }
}
